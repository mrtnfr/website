...
|-|-|-|-|
|Hero image|`\\\_YAK4032\\\_edit\\\_print.jpg`|Hero section (Noa with baby)|4:5 portrait|
|Book cover|`כריכה.png`|Book product image|3:4 vertical|
|About section|`marketing\\\_photo\\\_with\\\_toys.jpg`|About section main image|1:1 square|
|Profile headshot|`profile\\\_photo3.jpg`|Circular profile photo|1:1 square|
|Logo|`logo\\\_new\\\_1\\\_\\\_Vectorized\\\_.svg`|Header logo|Auto height|
